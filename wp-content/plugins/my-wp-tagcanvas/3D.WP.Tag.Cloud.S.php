...
//	$message = "<b>" . $plugin_data['Name'] . "</b>:<br>";
	$message = "<b>" . $plugin_data['Name'] . "</b>:<br>Dear users, this is the last version of the plugin. Starting from 17 Jan. 2018 it will no longer be supported. I'd like to thank you all who trusted and used it. Good luck!";
	$display_info = false;
